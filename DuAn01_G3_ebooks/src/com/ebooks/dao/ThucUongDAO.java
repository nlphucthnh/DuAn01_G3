...
public class ThucUongDAO {
    ...
    public void insert(ThucUong entity) {
        String sql="INSERT INTO ThucUong (MaThucUong, TenThucUong, Gia, moTa) VALUES (?, ?, ?, ?)";
    ...
    public void update(ThucUong entity) {
        String sql="UPDATE ThucUong SET TenThucUong=?, Gia=?, moTa=? WHERE MaThucUong=?";
        JdbcHelper.executeUpdate(sql,
                entity.getTenThucUong(),
                entity.getGia(),
                entity.getMoTa(),
    ...
    public ThucUong findByName(String id) {
