 ...
 * @author Thinh
 */
public class ReceiptDiaLog1 extends javax.swing.JDialog {

    /**
     * Creates new form SettingDiaLog
     */
    public ReceiptDiaLog1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiptDiaLog1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReceiptDiaLog1 dialog = new ReceiptDiaLog1(new javax.swing.JFrame(), true);
