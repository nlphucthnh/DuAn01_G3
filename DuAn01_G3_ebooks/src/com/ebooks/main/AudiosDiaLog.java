...
public class AudiosDiaLog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        pnlAudio.add(btnLuuThongTin, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 370, 180, 40));
...
//        InsertAudio();
        ...
        for(AudioSach x : listAudio){
            if(x.getMaSach().contains(txtMaSach.getText())){
                timThay = 1;
            }
        }
        if(timThay == 0) {
